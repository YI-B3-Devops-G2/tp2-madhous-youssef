...
// Wait 8 secondes that the postgres server initializes before connect to db 'tpdocker' and the node server listen on port 10080 
setTimeout(function () {
  ...
  app.listen(3000, function () {
    console.log('Server listen on port 10080 !')
  })
